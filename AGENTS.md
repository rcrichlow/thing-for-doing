...
**Generated:** 2026-03-13 America/New_York
**Commit:** 75dd15d
**Branch:** master
...
| Frontend app shell / routes | `client/src/App.jsx` | `/`, `/boards/:id` |
| Working memory frontend | `client/src/pages/working-memory/WorkingMemoryView.jsx` | Default landing page, keyboard-open modal composer |
...
| `BoardView` | page | `client/src/pages/BoardView.jsx` | Board detail, list creation, card detail drawer, DnD |
| `WorkingMemoryView` | page | `client/src/pages/working-memory/WorkingMemoryView.jsx` | Root page, entry list, lightweight modal composer |
...
- Do not reintroduce a third-party modal library for working memory unless there is an explicit product need.
